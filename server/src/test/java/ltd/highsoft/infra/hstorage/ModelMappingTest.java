...
class ModelMappingTest {
    ...
    void should_reject_aggregates_without_id_field_during_id_retrieving() {
        ...
        assertThat(thrown).hasMessage("Missing 'id' field in type 'ltd.highsoft.infra.hstorage.TypeWithoutIdField'!");
    }
    ...
    void should_reject_duplicated_mapping_entries_while_constructing() {
        ...
        assertThat(thrown).isInstanceOf(MappingException.class);
        assertThat(thrown).hasMessageContaining("Multiple mapping specified for aggregate class 'ltd.highsoft.infra.hstorage.TestAggregate': ");
        assertThat(thrown).hasMessageContaining("ltd.highsoft.infra.hstorage.TestAggregateMapping");
        assertThat(thrown).hasMessageContaining("ltd.highsoft.infra.hstorage.AnotherTestAggregateMapping");
    }
    ...
    void should_throw_exception_while_attempting_to_retrieve_collection_for_non_aggregate_mappings() {
        ...
        assertThat(thrown).isInstanceOf(MappingException.class);
        assertThat(thrown).hasMessageContaining("Class 'ltd.highsoft.infra.hstorage.TestNonAggregate' is mapped as a non-aggregate!");
    }
